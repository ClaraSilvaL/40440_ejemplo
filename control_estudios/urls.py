...
from control_estudios.views import listar_cursos, crear_curso, \
    buscar_cursos, eliminar_curso, editar_curso, EstudianteCreateView, EstudianteDeleteView, EstudianteDetailView, \
    EstudianteListView, EstudianteUpdateView
    #  listar_estudiantes,
